...
Als Syntax wurde sich für \texttt{\$f(x) = x\$} für Inline-\LaTeX und \texttt{\$\$f(x)=x\$\$} für Display-\LaTeX entschieden\footnote{Um das parsing simpel zu halten restriktieren wir diese Syntax vorerst nur auf einzelne Zeilen.}. Dies entspricht auch der KaTeX-Syntax, welche sowohl von HedgeDoc, als auch von GitHub oder GitLab genutzt wird.
